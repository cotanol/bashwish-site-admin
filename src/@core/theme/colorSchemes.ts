  ...
  return {
    ...
    dark: {
      palette: {
        ...
        text: {
          primary: `rgb(var(--mui-mainColorChannels-dark) / 0.95)`,
          secondary: `rgb(var(--mui-mainColorChannels-dark) / 0.75)`,
          disabled: `rgb(var(--mui-mainColorChannels-dark) / 0.45)`,
          primaryChannel: 'var(--mui-mainColorChannels-dark)',
          secondaryChannel: 'var(--mui-mainColorChannels-dark)'
        },
        divider: `rgb(var(--mui-mainColorChannels-dark) / 0.15)`,
        dividerChannel: 'var(--mui-mainColorChannels-dark)',
        background: {
          default: skin === 'bordered' ? '#2F3349' : '#282C3E',
          paper: '#2F3349',
          paperChannel: '47 51 73'
        },
        action: {
          active: `rgb(var(--mui-mainColorChannels-dark) / 0.7)`,
          hover: `rgb(var(--mui-mainColorChannels-dark) / 0.08)`,
          selected: `rgb(var(--mui-mainColorChannels-dark) / 0.12)`,
          disabled: `rgb(var(--mui-mainColorChannels-dark) / 0.35)`,
          disabledBackground: `rgb(var(--mui-mainColorChannels-dark) / 0.18)`,
          focus: `rgb(var(--mui-mainColorChannels-dark) / 0.12)`,
          focusOpacity: 0.12,
        ...
        customColors: {
          ...
          chatBg: '#242838',
          greyLightBg: '#3A3F55',
          inputBorder: `rgb(var(--mui-mainColorChannels-dark) / 0.3)`,
          tableHeaderBg: '#353A50',
          tooltipText: '#E7E3FC',
          trackBg: '#3D4259'
        }
      }
